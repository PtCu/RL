...
class ANet(nn.Module):   # ae(s)=a
    def __init__(self, s_dim, a_dim):
        ...
        self.out = nn.Linear(30, a_dim)         #a_dim=2
...
class DDPG(object):
    ...
    def save(self):
        torch.save(self.Actor_eval.state_dict(), 'actor_eval_params.pkl')
    
    def restore(self):
        self.Actor_eval.load_state_dict(torch.load('actor_eval_params.pkl'))
